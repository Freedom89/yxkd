...
The benchmark is against a GPU type defined by the TA; this is why you have to access to the cluster to test it! As shown, for my semester the benchmark / evaluation is done with a V100 GPU!
