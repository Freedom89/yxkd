...
For Assignments 1 & 2, you definitely need access to a NVIDIA GPU, and for assignment 2, you will need to use a GPU from the PACE cluster to evaluate your performance. There is no gradescope available but they code is provided to tell you if you are on the right track. Doing locally 
...
The TAs requires to use bitonic sort, as a way to implement parallel sorting algorithm (again, this is why I mention that your background really matters in this module), and after achieving it, you are free to explore other forms of speedup to achieve a 60x speedup for extra credit:
