---
title: Graduate Intro to Operating Systems
...
I took [introduction in operating systems](https://omscs.gatech.edu/cs-6200-introduction-operating-systems) during fall 2022 as my first course in OCSMS. My only preparation / experience with C is from [CS50X by havard](https://cs50.harvard.edu/x/2023/).

This is my first exposure on what happens behind an operating system, as well as a complied language such as C. There are 3 projects worth 15% each, 2 exams (fully mcq) worth 25% each and 5% participation points.

The important concepts/knowledge is the usage handlers and grpc section since I do encounter or use them quite often at work. Programming with C has also helped me my understanding of other languages, such as golang.
...
* [ocsms-notes](https://www.omscs-notes.com/operating-systems/welcome/)
* [notes provided by pmoore64](https://github.gatech.edu/pmoore64/notes)
...
* The relationship between process and thread!
  ...
  * Reader/Writer problem, deadlocks, workers, queues.
  * Different design patterns.
  * Dealing with thread performances.
...
* Then, if you still have time, read the papers.
