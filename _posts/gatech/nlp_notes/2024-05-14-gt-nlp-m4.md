...
$$
P(W_1=w_1,...,W_{n-1} = w_{n-1}) = \prod_{t=1}^n P(W_t = w_t \lvert W_1=w_1,...,W_{t-1}=w_{t-1} ; \theta)
$$
...
$$
norm \bigg(\bigg\langle \frac{log P(w_1)}{T}, ..., \frac{P(w_{\lvert \mathcal{v} \lvert})}{T}\bigg\rangle\bigg)
$$
